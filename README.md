...
## Usage
Your CPU must support the AVX2 and SHA instruction sets. \
For optimal performance it is recommended to have at least 32GB of RAM. If you have less, you may need to reduce `prefix_size` and `suffix_size` to running out of memory. \
